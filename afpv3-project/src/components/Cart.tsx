...
const Cart = ({ setShowCart }: any) => {
  ...
  return (
    <div
      className="bg-[#0000007b] w-full h-screen fixed left-0 top-0 z-20"
    ...
    >
      ...
      >
        <RxCross1
          className="absolute right-0 top-6 m-6 text-[24px] cursor-pointer"
          onClick={() => setShowCart(false)}
        />
        <h3 className="pt-6 text-lg font-medium text-grey-600 uppercase">
          Your Cart
        </h3>
